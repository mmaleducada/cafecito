...
const Administrador = () => {
  ...
  useEffect(() => {
    // consultar a la api (desde queries.js) y guardar la respuesta en el state
    ...
    return (
        ...
        <Table responsive striped bordered hover>
          ...
          <tbody>
            {
              productos.map((producto)=><ItemProducto key={producto.id} producto={producto} productos={productos} setProductos={SetProductos}></ItemProducto>)
            }
          </tbody>
        </Table>
      </section>
